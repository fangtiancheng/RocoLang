...
pub fn docs() -> Vec<StdlibFunctionDetails> {
    vec![
        ...
        super::stdlib_doc!("friend", "query_nicknames", return_type: "FriendNickname[]", "批量查询好友昵称。", params: ["friend_uins" => "好友 UIN 数组。"], returns: "好友昵称列表。", examples: ["let names = friend::query_nicknames([123456]);"]),
    ]
}

...
impl RocoErrorDetailScriptView<'_> {
    pub(super) fn general_lock_target(&self) -> Option<RocoGeneralLockTarget> {
        match self.0 {
    ...
    pub(super) fn general_lock_target_code(&self) -> String {
        self.general_lock_target()
            .map(|target| target.code().to_string())
            .unwrap_or_default()
    }

    pub(super) fn invalid_param_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn invalid_param_name(&self) -> String {
        match self.0 {
    ...
    pub(super) fn invalid_param_value(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn invalid_param_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn invalid_param_expected(&self) -> String {
        match self.0 {
    ...
    pub(super) fn invalid_param_protocol_field(&self) -> String {
        match self.0 {
    ...
    pub(super) fn invalid_param_rejected_source_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn unsupported_module(&self) -> String {
        match self.0 {
    ...
    pub(super) fn unsupported_function_name(&self) -> String {
        match self.0 {
    ...
    pub(super) fn function_context_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn function_context_combat_phase_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn query_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn query_skill_index(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn static_data_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn static_data_position(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn static_data_function_name(&self) -> String {
        match self.0 {
    ...
    pub(super) fn static_data_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn static_data_active_config_source_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn system_operation_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn system_source_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn system_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn stdlib_bridge_operation_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn stdlib_bridge_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn activity_operation_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn activity_operation_activity_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn activity_operation_field_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn activity_operation_count(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn activity_operation_limit(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn activity_operation_value(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn combat_action_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn combat_action_position(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn combat_action_skill_id(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn combat_action_item_id(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn combat_wait_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn combat_wait_combat_phase_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn combat_wait_elapsed_ms(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn combat_runtime_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn combat_command_failure_kind(&self) -> Option<ScriptCombatCommandFailureKind> {
        match self.0 {
    ...
    pub(super) fn combat_command_failure_kind_code(&self) -> String {
        self.combat_command_failure_kind()
            .map(|kind| kind.code().to_string())
            .unwrap_or_default()
    }

    pub(super) fn pending_response_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn pending_http_response_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn expected_http_response_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn actual_http_response_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn pending_response_combat_phase_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn pending_response_net_target_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn pending_response_expected_action_kind(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn pending_response_expected_spirit_index(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn pending_response_actual_action_kind(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn pending_response_actual_spirit_index(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn response_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn expected_response_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn actual_response_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_wait_context_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_system_failure_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_combat_intent_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_combat_validation_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_spirit_index(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn request_value(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn request_combat_protocol_error_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn request_combat_protocol_error_value(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn session_memory_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn session_memory_key(&self) -> String {
        match self.0 {
    ...
    pub(super) fn session_memory_expected_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn session_memory_actual_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn lookup_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn lookup_entity_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn spirit_operation_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn spirit_operation_spirit_id(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn spirit_operation_catch_time(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn bridge_channel_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn bridge_operation_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn bridge_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn net_response_parse_target(&self) -> String {
        self.net_response_parse_target_code()
    }

    pub(super) fn net_response_parse_target_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn net_response_parse_source_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn net_response_parse_protocol_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn net_response_parse_protocol_error_type(&self) -> String {
        self.net_response_parse_protocol_error_type_code()
    }

    pub(super) fn net_response_parse_protocol_error_type_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn net_response_parse_unexpected_cmd_id(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn return_code_kind_code(&self) -> String {
        match self.0 {
    ...
    pub(super) fn return_code_value(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn return_code_message(&self) -> String {
        match self.0 {
    ...
    pub(super) fn http_business_result_code(&self) -> i64 {
        match self.0 {
    ...
    pub(super) fn http_business_request_context(&self) -> String {
        match self.0 {
    ...
    pub(super) fn http_business_message(&self) -> String {
        match self.0 {

...
pub trait RocoStdLib: Send {
    ...
    fn magic_pioneer_vanguard_lord_exchange(
        ...
        unsupported("magic_pioneer::vanguard_lord_exchange")
    }
    fn magic_pioneer_vanguard_lord_complete(&mut self) -> Result<MagicPioneerInfo> {
        unsupported("magic_pioneer::vanguard_lord_complete")
    }

    fn magic_pioneer_little_angel_angie_query(&mut self) -> Result<MagicPioneerInfo> {
        unsupported("magic_pioneer::little_angel_angie_query")
    }
    ...
    fn magic_pioneer_blue_water_beast_one_key(&mut self) -> Result<MagicPioneerInfo> {
        unsupported("magic_pioneer::blue_water_beast_one_key")
    }
    ...
    fn magic_pioneer_magic_tail_cat_query(&mut self) -> Result<MagicPioneerInfo> {
        unsupported("magic_pioneer::magic_tail_cat_query")
    }

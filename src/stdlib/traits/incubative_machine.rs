...
pub trait RocoIncubativeMachineStdLib: Send {
    ...
    fn incubative_machine_query_info(&mut self, _which: i64) -> Result<Vec<u8>> {
    ...
    fn incubative_machine_vip_speed_up(&mut self, _which: i64) -> Result<Vec<u8>> {
        unsupported("incubative_machine::vip_speed_up")
    }
    fn incubative_machine_teach(&mut self, _which: i64) -> Result<Vec<u8>> {
        unsupported("incubative_machine::teach")
    }
    fn incubative_machine_terminate(&mut self, _which: i64) -> Result<Vec<u8>> {
        unsupported("incubative_machine::terminate")
    }
    fn incubative_machine_get_spirit(&mut self, _which: i64) -> Result<Vec<u8>> {
        unsupported("incubative_machine::get_spirit")
    }
    fn incubative_machine_set_complete_guide(&mut self) -> Result<Vec<u8>> {
